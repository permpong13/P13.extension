...
__doc__ = "หน้าต่างรวม, แก้ไขชื่อ Type, และปลดล็อครายการ Parameter ให้แสดงครบทุกตัว"
...
def get_revit_name(element, is_type=False):
    """อ่านชื่อให้ตรงกับ Revit Properties"""
...
def get_all_possible_parameters(doc, family_symbol):
    ...
    # 4. Shared Parameters (ถ้ามี)
    # (ครอบคลุมในขั้นตอนที่ 3 แล้ว)
...
class MainConfigForm(Form):
    ...
    def InitializeComponent(self):
        ...
        self.lbl_note = Label()
        self.lbl_note.Text = "(CSV Type จะถูกใช้ก่อนถ้ามี)"
        ...
        self.btn_ok.Location = Point(230, 330)
        ...
        self.btn_cancel.Location = Point(350, 330)
