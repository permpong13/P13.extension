...
import math
# Import clr เพื่อโหลด Assembly ของ .NET
import clr
clr.AddReference("System.Windows.Forms")
clr.AddReference("System.Drawing")
clr.AddReference("System")

# --- ส่วนสำคัญที่แก้ไข: Import Namespace หลักเพื่อใช้เรียก Enum ---
...
# Import Control ต่างๆ เพื่อความสะดวกในการเขียนโค้ด
from System.Windows.Forms import (
    Form, Label, TextBox, Button, FormStartPosition, DialogResult,
    FormBorderStyle, TableLayoutPanel, FlowLayoutPanel, Panel,
    DockStyle, AnchorStyles, RowStyle, ColumnStyle, SizeType,
    Padding, BorderStyle, FlatStyle, AutoSizeMode
    # ลบ ContentAlignment และ Keys ออกจากตรงนี้ เพื่อป้องกัน error
)
...
FONT_TITLE = Font("Segoe UI", 14, FontStyle.Bold)
...
class iOSStyleNEInputForm(Form):
    ...
    def InitializeComponent(self):
        ...
        self.header_panel.BackColor = Color.White
        header_separator = Panel()
        header_separator.Height = 1
        header_separator.Dock = DockStyle.Bottom
        header_separator.BackColor = Color.FromArgb(230, 230, 230)
        ...
        # --- แก้ไขการเรียกใช้ ContentAlignment ---
        ...
        self.innerInputTable.BackColor = Color.White
        ...
        sep_panel.BackColor = Color.White
        sep_line = Panel()
        sep_line.Height = 1
    ...
    def on_form_shown(self, sender, args):
        try:
            # Hack ทำปุ่ม OK ให้มีมุมมน
            region = System.Drawing.Region.FromHrgn(
                System.Runtime.InteropServices.DllImport("gdi32.dll").CreateRoundRectRgn(0, 0, self.btn_ok.Width, self.btn_ok.Height, 12, 12)
            )
            self.btn_ok.Region = region
            region_cancel = System.Drawing.Region.FromHrgn(
                System.Runtime.InteropServices.DllImport("gdi32.dll").CreateRoundRectRgn(0, 0, self.btn_cancel.Width, self.btn_cancel.Height, 12, 12)
            )
            self.btn_cancel.Region = region_cancel
        except:
            pass
        self.tb_n.Focus()

    def textbox_key_down(self, sender, args):
        # --- แก้ไขการเรียกใช้ Keys ---
