...
from System.Windows.Controls import (
    ...
    ComboBox, ListBox, CheckBox, DataGridSelectionMode
)
...
class SuperSheetsUltimate(Window):
    ...
    def _setup_ui(self):
        ...
        sp_f = StackPanel(Orientation=Orientation.Horizontal)
        ...
        gb_format.Content = sp_f; Grid.SetRow(gb_format, 0); main_layout.Children.Add(gb_format)
